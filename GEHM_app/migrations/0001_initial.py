...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Contractor',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='contractor', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='GuestEmployee',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='GuestEmployee', serialize=False, to=settings.AUTH_USER_MODEL)),
                ('Name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='guest_chat', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='CHAT_CON',
            fields=[
                ...
                ('desc', models.TextField()),
                ('date', models.DateField(auto_now=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='CHAT_AD',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Amount', models.CharField(choices=[('500', '500'), ('1000', '1000'), ('1500', '1500')], max_length=100)),
                ('date', models.DateField(auto_now=True)),
